                          ...
                          <ul class="contacts-list">
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?= base_url()?>assets/adminlte/img/user7-128x128.jpg"
                                  alt="User Avatar"
                                />
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?= base_url()?>assets/adminlte/img/user5-128x128.jpg"
                                  alt="User Avatar"
                                />
                            ...
                            <li>
                              <a href="#">
                                <img
                                  class="contacts-list-img"
                                  src="<?= base_url()?>assets/adminlte/img/user6-128x128.jpg"
                                  alt="User Avatar"
                                />
